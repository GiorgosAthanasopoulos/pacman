...
#define COLOR_GHOST_POWER DARKBLUE
#define COLOR_WALL_PERIMETER BLACK
#define COLOR_UI_TEXT WHITE
#define COLOR_PACMAN_POWER RED
...
// sprites
#define PACMAN_FRAME_COUNT 3
#define PACMAN_ANIM_INTERVAL 0.1f
#define EYES_FRAME_COUNT 4
#define GHOST_FRAME_COUNT 2
#define GHOST_COLOR_COUNT 4
